...
tagElectronIdMod.SetIdType(mithep.ElectronTools.kCustomIdTight)
tagElectronIdMod.SetIsoType(mithep.ElectronTools.kPFIso)
...
probeElectronIdMod.SetIdType(mithep.ElectronTools.kCustomIdTight)
probeElectronIdMod.SetIsoType(mithep.ElectronTools.kPFIso)
